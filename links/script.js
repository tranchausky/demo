...
function buildListVideo(dataIn) {
    ...
    for (var key in dataIn) {
        ...
        if (dataAt.is_show == false && typeof dataAt.videId != undefined) {
            str += '<div class="col-sm-3 col-xs-4"><img class="img-thumbnail" onclick="changeLinkVideo(&apos;' + dataAt.videId + '&apos;,&apos;' + dataAt.id_cat + '&apos;,&apos;' + key + '&apos;)" str-big="' + dataAt.url + '" src="https://i.ytimg.com/vi/' + dataAt.videId + '/default.jpg" alt="">' + dataAt.title + '</div>'
        } else {
