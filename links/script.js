...
function changeVideo(videoUrl, cat_id, key) {
    ...
    if (domain == 'facebook.com') {
        str += '<p><a href="http://03way.pages.dev/goto.html?url=' + videoUrl + '" target="_blank">Link video</a></p>';
        ...
        str = '<p><a href="http://03way.pages.dev/goto.html?url=' + videoUrl + '" target="_blank">Link video</a></p><iframe width="400" height="500" src="' + videoUrl + '" ></iframe>'
    }
    // return;
...
function changeLinkVideo(videId, videoUrl, key, cat_id) {
    ...
    var str = '<p><a href="http://03way.pages.dev/goto.html?url=' + videoUrl + '" target="_blank">Link video</a></p><iframe src="https://www.youtube.com/embed/' + videId + '" width="100%" height="400px" allowfullscreen></iframe>';
    $('#video-iframe').html(str);
}
function changeVideoBase64(videId, videoUrl, key) {
    var decodedString = atob(videId);

    var str = '<p><a href="http://03way.pages.dev/goto.html?url=' + videoUrl + '" target="_blank">Link video</a></p>' + decodedString;
    $('#video-iframe').html(str);
}
...
function contactHtmlFromObject(contact, key) {
    ...
    html += '<p><a href="http://03way.pages.dev/goto.html?url=' + contact.email + '" target="_blank" title="' + contact.email + '">' + contact.email + '</a><button onclick="edithome(&#39;'+key+'&#39;)">Edit</button></p>';
    var textSelect = ''
